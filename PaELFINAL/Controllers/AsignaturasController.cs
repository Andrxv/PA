...
namespace PaELFINAL.Controllers
{
    public class AsignaturasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "asignaturaID,NombreAsignatura,creditos")] Asignatura asignatura)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "asignaturaID,NombreAsignatura,creditos")] Asignatura asignatura)
        {
            if (ModelState.IsValid)
            {
